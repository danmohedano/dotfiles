...
# Execution of wall
wal -i $2
echo "Executed pywal with the following image: $2"
...
# Configuration of konsole colorscheme (and addition of blur)
cp .cache/wal/colors-konsole.colorscheme .local/share/konsole
KONSOLE_CONFIG=$(head -n -9 .local/share/konsole/colors-konsole.colorscheme)
echo -e "${KONSOLE_CONFIG}\n
[General]
Anchor=0.5,0.5
Blur=true
ColorRandomization=false
Description=Custom wal colorscheme
FillStyle=Tile
Opacity=0.5
Wallpaper=
WallpaperOpacity=1" > .local/share/konsole/colors-konsole.colorscheme

echo "Updated konsole config file"
